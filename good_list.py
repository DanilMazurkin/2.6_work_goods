...
list_with_goods = good_list.get_good_list()
good_list.load_goods_from_file("./list_goods.txt")

print(good_list.get_mean_price_goods(list_with_goods))
print(good_list.get_good_with_max_price(list_with_goods))
print(good_list.get_good_with_min_price(list_with_goods))
print(good_list.get_good_with_max_count(list_with_goods))
print(good_list.get_good_with_min_count(list_with_goods))
